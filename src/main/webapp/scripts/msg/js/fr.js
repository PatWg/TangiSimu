...
Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] = "Si la condition est vraie, alors exécute certains blocs.";
Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] = "Si la condition est vraie, alors exécute certains blocs, sinon en exécute des autres.";
...
Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] = "Exécute des instructions un nombre défini de fois.";
...
Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] = "Condition vraie ou fausse.";
...
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_EQ"] = "Condition vraie si les deux entrées sont égales.";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GT"] = "Condition vraie si la première entrée est plus grande que la seconde.";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GTE"] = "Condition vraie si la première entrée est plus grande ou égale à la seconde.";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LT"] = "Condition vraie si la première entrée est plus petite que la seconde.";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LTE"] = "Condition vraie si la première entrée est plus petite ou égale à la seconde.";
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_NEQ"] = "Condition vraie si les deux entrées sont différentes.";
Blockly.Msg["LOGIC_NEGATE_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#not";  // untranslated
Blockly.Msg["LOGIC_NEGATE_TITLE"] = "pas %1";
Blockly.Msg["LOGIC_NEGATE_TOOLTIP"] = "Oppose la condition qui suit.";
...
Blockly.Msg["LOGIC_OPERATION_TOOLTIP_AND"] = "Condition vraie si les deux entrées sont vraies.";
Blockly.Msg["LOGIC_OPERATION_TOOLTIP_OR"] = "Condition vraie si au moins une des entrées est vraie.";
...
Blockly.Msg["MATH_IS_TOOLTIP"] = "Vérifie si un nombre est pair, impair, premier, entier, positif, négatif, ou s’il est divisible par un certain nombre, puis renvoie vrai ou faux.";
Blockly.Msg["MATH_IS_WHOLE"] = "est entier";
Blockly.Msg["MATH_MODULO_HELPURL"] = "https://en.wikipedia.org/wiki/Modulo_operation";
Blockly.Msg["MATH_MODULO_TITLE"] = "reste de %1 ÷ %2";
Blockly.Msg["MATH_MODULO_TOOLTIP"] = "Renvoie le reste de la division euclidienne des deux nombres.";
Blockly.Msg["MATH_MULTIPLICATION_SYMBOL"] = "×";  // untranslated
Blockly.Msg["MATH_NUMBER_HELPURL"] = "https://fr.wikipedia.org/wiki/Nombre";
Blockly.Msg["MATH_NUMBER_TOOLTIP"] = "Un nombre au choix.";
...
Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] = "Renvoie la moyenne (arithmétique) des valeurs numériques dans la liste.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] = "Renvoie le plus grand nombre dans la liste.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] = "Renvoie le nombre médian de la liste.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MIN"] = "Renvoie le plus petit nombre dans la liste.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_MODE"] = "Renvoie une liste des élément(s) le(s) plus courant(s) dans la liste.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] = "Renvoie un élément dans la liste au hasard.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_STD_DEV"] = "Renvoie l’écart-type de la liste.";
Blockly.Msg["MATH_ONLIST_TOOLTIP_SUM"] = "Renvoie la somme de tous les nombres dans la liste.";
...
Blockly.Msg["MATH_RANDOM_INT_TOOLTIP"] = "Renvoie un entier aléatoire entre les deux nombres spécifiés inclus.";
...
Blockly.Msg["NEW_VARIABLE"] = "Clique ici pour créer une variable";
...
Blockly.Msg["VARIABLES_SET_TOOLTIP"] = "Fixe cette variable pour qu’elle soit égale à la valeur donnée.";
Blockly.Msg["VARIABLE_ALREADY_EXISTS"] = "Une variable appelée '%1' existe déjà.";
Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "Une variable nommée '%1' existe déjà pour une autre variable de type '%2'.";
